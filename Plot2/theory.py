...
def plot_bc20_vs_bc200(ax):
    ...
    ax.plot(x, bc_transmissiontime_20byte/1000, 'r^-', label='Broadcast', markerfacecolor='none', linewidth=1, color='darkmagenta')
...
def plot_bc_up_to_200(ax):
    ax.plot(x2, bc_transmissiontime_up_to_400/1000, 'rs-', label='Broadcast', markerfacecolor='none', linewidth=1, color='darkmagenta')
