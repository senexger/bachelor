...
Beim Multicast ist der einsatz von Acknolegements möglich, weil der Sender weiß wieviele Empfänger es gibt.
...
To undersant what ESP-NOW does it need to take a look to the vendor-specific action frame transmiting ESP-NOW data,
...
\todo{255 != 250 is it really that important, skip?}
