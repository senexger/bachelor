...
The chip is delivered with several development boards.
The chip is promoted with: \todo{this is cited from: link zum esp32 datasheet}
\begin{itemize}
	\item 802.11 b/g/n with up to 150 Mbps
	...
	\item Simultaneous support for Infrastructure Station, SoftAP, and Promiscuous modes
	\item Bluetooth v4.2 BR/EDR and Bluetooth LE specifications
	\item Xtensa® single-/dual-core 32-bit LX6 microprocessor(s)
	\item Advanced Peripheral Interfaces: GPIO, ADC, DAC, touch sensors, hall sensor, 
	SPI, I2S, I2C, UART, CAN, RMT (TX/RX), Motor/LED PWM 
\end{itemize}

\TODO{add picture of an ESP layout}
