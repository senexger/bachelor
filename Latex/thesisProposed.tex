...
For the purpose of this analysis, the controller transmits 20 byte (analogue to 20 DMX channels) to 8 WESs.
...
To push the idea of rapid repetion even further, should also temporarily occuring noise be taken into account.\todo{displaced repetition or delayed repetition which is better?}
