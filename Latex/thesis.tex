...
\subsection*{DMX - Classical Approach}
...
\subsection*{ESP Platform}

\subsubsection*{ESP32 Hardware}
However, due to the progress in radio technology, wireless solutions are becoming more and more common.
...
\TODO{title of chapter: ESP-Now DMX Like Protocol}
...
\item python script
\item saving values
\item digital encoding e.g.: 7774774727177
\end{itemize}
