...
\acrodef{FHSS}{Frequencey Hopping}
\acrodef{STA}{Station}
...
In this chapter I discuss the fundamentals required for understanding the different implementations in the Data Link Layer.\todo{eigener Wortlaut}
Located in the second layer of the \ac{OSI} Model.\todo{refrence to table below}
...
\TODO{Rewrite introductino in chapter Fundamentals}
...
Modulation: \ac{DSSS} introduced in 802.11b with larger bit rates: 1, 2, 5.5, 11 Mbit/s
Automatic fall-back to lower bitrates in case of bad radio channel.\todo{eigene Worte}.
\begin{itemize}
	\item 802.11b \\
	supports larger bitrates in \ac{DSSS} from 1Mbit/s to 11Mbit/s.
	It is in the 2.4 GHz ISM band.
	\item 802.11a and 802.11g \\
	\ac{OFDM} Data rates up to 54 Mbit/s are supported. 802.11a is in the 5GHz ISM band.
	\item 802.11n\\
	Multiple antennas to increase data rates. Using 2.4 GHz and 5GHz ISM band
	\item 802.11ac\\
	Support of wider channel and out of it higher bitrates.
	\item 802.11ax\\
	Like 802.11ac but with additional use of the 6GHz ISM band and better power control. 
	Also called WiFi6.
\end{itemize}

\subsection{802 Stuff}
