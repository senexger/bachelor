...
The most similar approach using ESP-Now to Art-Net \cref{sec:artnet} is to send instead of \ac{UDP} packets, 
	is to transmit Unicast transmissions streight from the data link layer to all fixtures.
\TODO{fix picture of Protocol stack}
...
\TODO{RR Formel: ER? Intervall unbeschränkt?} 
\begin{align*}
...
\todo{has this a proper name, like broadcast address?} to add a peer with the broadcast \ac{MAC}.
...
\end{lstlisting}
\TODO{fix colorscheme of code examples}
