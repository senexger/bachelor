...
\todo{yes.... actually why such a big difference?}
...
For the slim broadcast, 160 byte packets were distributed in a 600 sequences, the experiment was repeated 1000 times.
...
\todo{tell about syncronization problems}
...
\begin{table}[h]
	...
	& \multicolumn{1}{c}{Frequency in $\mu$s}
