...
* TODO Broadcast Rapid Rapitition Zeitmessung
...
- [ ] In der Auswertung kann man dann wieder herauslesen, ob der Broadcast bei
  einem, zweien oder allen drei angekommen ist.
* DONE unicast testen
CLOSED: [2021-06-03 Do 04:21]
* TODO Dauer bei Unicast vs Broadcast bei 50 Wiederholungen ausgeben lassen
* TODO Code aufräumen:
253, 254, 255 durch Konstanzen ersetzen wie IS_METADATA, IS_DMX_DATA, IS_SEND_RESULTS
* TODO Alle Kommentare in VERBOSE/DEBUG Klammern setzen
* TODO Fix Error: after successfull test, Master needs to be restarted
